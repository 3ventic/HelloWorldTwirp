...
func NewHelloWorldProtobufClient(baseURL string, client HTTPClient, opts ...twirp.ClientOption) HelloWorld {
	...
	serviceURL += baseServicePath(clientOpts.PathPrefix(), "twitch.twirp.example.helloworld", "HelloWorld")
	urls := [1]string{
		serviceURL + "Hello",
	}
...
func (s *helloWorldServer) ServeHTTP(resp http.ResponseWriter, req *http.Request) {
	...
	if pkgService != "twitch.twirp.example.helloworld.HelloWorld" {
...
func (s *helloWorldServer) PathPrefix() string {
	return baseServicePath(s.pathPrefix, "twitch.twirp.example.helloworld", "HelloWorld")
}
...
var twirpFileDescriptor0 = []byte{
	...
	,
}
